...
var Meeting = function (socketioHost) { 
    ...
    function joinRoom(name) {
        ...
        if (_room !== '') {
            console.log('criarSala room', _room);
            _defaultChannel.emit('criarSala', {room:_room, from:_myID});
        }
    ...
    function initDefaultChannel() {
        ...
        _defaultChannel.on('salaCriada', function (room){
          console.log('Sala Criado ' + room);
          _isInitiator = true;
        });

        _defaultChannel.on('entrarNaSala', function (room){
            console.log('Another peer made a request to join room ' + room);
        });

        _defaultChannel.on('entrou', function (room){
            console.log('This peer has entrou room ' + room);
        });
